...
audio_devices_t AudioPolicyManager::getDeviceForStrategy(routing_strategy strategy, bool fromCache)
{
    ...
    case STRATEGY_SONIFICATION_RESPECTFUL:
        ...
        } else if (AudioPolicyManagerBase::isStreamActive(AudioSystem::MUSIC, SONIFICATION_RESPECTFUL_AFTER_MUSIC_DELAY)) {
    ...
    case STRATEGY_PHONE:
        ...
        default:    // FORCE_NONE
            ...
            if (mHasA2dp && !isInCall() &&
                    ...
                    (AudioPolicyManagerBase::getA2dpOutput() != 0) && !mA2dpSuspended) {
                                                      ...
                                                      const char *device_address)
{
    ...
    if (AudioSystem::isOutputDevice(device)) {
        ...
        case AudioSystem::DEVICE_STATE_AVAILABLE:
            ...
            if (AudioPolicyManagerBase::checkOutputsForDevice((audio_devices_t)device, state, outputs) != NO_ERROR) {
                return INVALID_OPERATION;
            }
        ...
        case AudioSystem::DEVICE_STATE_UNAVAILABLE: {
            ...
            AudioPolicyManagerBase::checkOutputsForDevice((audio_devices_t)device, state, outputs);
            if (mHasA2dp && AudioSystem::isA2dpDevice(device)) {
...
uint32_t AudioPolicyManager::setOutputDevice(audio_io_handle_t output, audio_devices_t device, bool force, int delayMs)
{
    ...
    muteWaitMs = AudioPolicyManagerBase::checkDeviceMuteStrategies(outputDesc, prevDevice, delayMs);
